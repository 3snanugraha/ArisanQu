...
<body>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Undian Arisan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card rounded-4">
            <div class="card-body">
              <h5 class="card-title">Undian Arisan</h5>
              <p>Gunakan tombol di bawah ini untuk melakukan undian arisan. Sistem akan secara acak memilih pemenang undian dari anggota yang terdaftar.</p>
              <button class="btn btn-brand-primary mt-2 mb-4 rounded-pill" onclick="drawLottery()"><i class="bi bi-ticket-perforated"></i><span> Lakukan Undian </span></button>

              
              <!-- Result of the draw -->
              <div id="result" class="alert alert-info" style="display: none;">
                <h4 class="alert-heading">Pemenang Undian!</h4>
                <p id="winner-name"></p>
              </div>
  ...
  <script>
    function drawLottery() {
      // Simulasi pengambilan data anggota untuk undian
      const members = [
        { id: 1, name: 'Anggota 1' },
        { id: 2, name: 'Anggota 2' },
        { id: 3, name: 'Anggota 3' },
      ...
      document.getElementById('winner-name').innerText = 'Selamat kepada ' + winner.name + '!';
